...
public:
  ...
  // allocate/deallocate дл€ демонстрац≥њ
...
//
//  // iterate from chead() to cend() Ч we expect to see N elements
//  size_t idx = 0;
...
//  // data() may be nullptr Ч only ensure no crash when obtaining iterators
//  auto b = z.chead();
//  auto e = z.cend();
